...
const themeSwitcherLabel=`${themeSwitcherText.textContent}(${btnToActive.dataset.bsThemeValue})`themeSwitcher.setAttribute('aria-label',themeSwitcherLabel)
...
setTheme(theme)
showActiveTheme(theme,true)})})})})();(()=>{'use strict'
